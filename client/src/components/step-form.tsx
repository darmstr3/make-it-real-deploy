      ...
      >
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-4 pt-6">
          <Button
            ...
            className="w-full sm:w-auto px-6 py-3 text-base border border-gray-300 hover:bg-gray-50 transition-all duration-200"
          >
          ...
          <Button
            ...
            className={`w-full sm:w-auto px-4 md:px-8 py-3 text-base font-medium rounded-full shadow-md hover:shadow-lg transition-all duration-300 transform hover:translate-y-[-2px] ${
              isLastQuestion 
          ...
          >
            {loading ? (
              <div className="flex items-center justify-center">
                ...
                <span className="whitespace-nowrap">Creating Your Positioning...</span>
              </div>
            ) : (
              <div className="flex items-center justify-center whitespace-nowrap">
                {isLastQuestion ? "Generate Positioning Kit" : "Continue"}
                {!isLastQuestion && (
                  <svg className="h-5 w-5 ml-2 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
